...
T_max_GV = 200                                                               #max operation time per GV
EV_velocity = 0.67
GV_velocity = 0.67
GV_cost = 1.58 #4.5/6.5  #0.58 #0.25 per ton mile
EV_cost = 12.58 # 0.3    #0.38  #$/kWh   or 0.035 per ton mile
M = 4
